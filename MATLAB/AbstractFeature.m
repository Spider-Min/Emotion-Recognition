addpath('C:\Users\Admin\PycharmProjects\Emotion_Detection\MATLAB\Balance\siftDemoV4')
%traversal all images
path = 'C:\Users\Admin\PycharmProjects\Emotion_Detection\images\';
fileExt = '*.jpg';  
files = dir(fullfile(path,fileExt));
len = size(files,1);  
fid = fopen('C:\Users\Admin\PycharmProjects\Emotion_Detection\image_data.txt','w');
